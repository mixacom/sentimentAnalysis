...
public abstract class DetectLanguage {
    ...
    public static String simpleDetect(final String text) throws APIError {
        List<com.detectlanguage.Result> results = detect(text);
    ...
    public static List<com.detectlanguage.Result> detect(final String text) throws APIError {
    ...
    public static List<List<com.detectlanguage.Result>> detect(final String[] texts)
            throws APIError {
        HashMap<String, Object> params = new HashMap<String, Object>();
